...
- <a href=https://t.me/matthewmurdock001>『KDramaWorld』</a>
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/kdramaworld_ongoing)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
Message <b>: {}</b>"""
    ...
    CAPTION = """
📂 <em>File Name</em>: <code>KDramaWorld|{file_name}</code> 

🖇 <em>File Size</em>: <code>{file_size}</code> 

❤️‍🔥 </i>Join</i> [KDramaWorld](https://t.me/kdramaworld_ongoing)  

🖥 <i>Requests</i> - ||@kdramasmirrorchat|| """
